...
1. Open `pwsh` and run the [generate-dev-sln script](https://github.com/dotnet/dotnet-monitor/blob/$("GITHUB_SHA")/generate-dev-sln.ps1), providing a path to your local copy of the diagnostics repo.
