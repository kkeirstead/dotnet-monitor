...
* Collection rules are registered [here](https://github.com/dotnet/dotnet-monitor/blob/bea5b0284c22cecb5edfa8e35ad353a54a6b8fe0/src/Tools/dotnet-monitor/ServiceCollectionExtensions.cs#L141). When adding a new trigger or action, these types need to be added here to take effect. This section is also responsible for making sure options get configured and validated.
