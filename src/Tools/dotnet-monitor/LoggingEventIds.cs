...
namespace Microsoft.Diagnostics.Tools.Monitor
{
    ...
    internal enum LoggingEventIds
    {
        ...
        ExtensionProbeStart = 73,
        ExtensionProbeRepo = 74,
        ExtensionProbeSucceeded = 75,
        ExtensionProbeFailed = 76,
        ExtensionStarting = 77,
        ExtensionConfigured = 78,
        ExtensionEgressPayloadCompleted = 79,
        ExtensionExited = 80,
        ExtensionOutputMessage = 81,
        ExtensionErrorMessage = 82,
        ExtensionNotOfType = 83,
        ExtensionDeclarationFileBroken = 84,
        ExtensionProgramMissing = 85,
        ExtensionMalformedOutput = 86
    }
