...
namespace Microsoft.Diagnostics.Tools.Monitor
{
    ...
    internal enum LoggingEventIds
    {
        ...
        EgressProviderUnableToFindPropertyKey = 10,
        ...
        ExperienceSurvey = 57,
        DiagnosticPortNotInListenModeForCollectionRules = 58,
        RuntimeInstanceCookieFailedToFilterSelf = 59,
        ParsingUrlFailed = 60,
        IntermediateFileDeletionFailed = 61,
        DiagnosticPortDeleteAttempt = 62,
        DiagnosticPortDeleteFailed = 63,
        DiagnosticPortAlteredWhileInUse = 64,
        DiagnosticPortWatchingFailed = 65,
        ExtensionProbeStart = 66,
        ExtensionProbeRepo = 67,
        ExtensionProbeSucceeded = 68,
        ExtensionProbeFailed = 69,
        ExtensionStarting = 70,
        ExtensionConfigured = 71,
        ExtensionEgressPayloadCompleted = 72,
        ExtensionExited = 73,
        ExtensionOutputMessage = 74,
        ExtensionErrorMessage = 75,
        ExtensionNotOfType = 76,
        ExtensionDeclarationFileBroken = 77,
        ExtensionProgramMissing = 78,
        ExtensionMalformedOutput = 79
    }
