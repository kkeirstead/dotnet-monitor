...
namespace Microsoft.Diagnostics.Monitoring.Tool.FunctionalTests.HttpApi
{
    internal sealed class ApiClient
    {
        ...
        public async Task<ResponseStreamHolder> CaptureExceptionsAsync(ExceptionsFormat format, CancellationToken token)
        {
            string uri = FormattableString.Invariant($"/exceptions");
