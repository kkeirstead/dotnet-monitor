...
namespace Microsoft.Diagnostics.Monitoring.StartupHook.Exceptions.Eventing
{
    ...
    public sealed class ExceptionsEventSourceTests
    {
        ...
        public void ExceptionsEventSource_WriteException_LevelTooHigh()
        {
            ...
            source.ExceptionInstance(5, 7, ObjectDisposedExceptionMessage, Array.Empty<ulong>(), DateTime.UtcNow, Array.Empty<ulong>(), null, null);
        ...
        public void ExceptionsEventSource_WriteException_NotEnabled()
        {
            ...
            source.ExceptionInstance(7, 9, OperationCancelledExceptionMessage, Array.Empty<ulong>(), DateTime.UtcNow, Array.Empty<ulong>(), null, null);
