...
namespace Microsoft.Diagnostics.Monitoring.WebApi
{
    internal class EgressOperation : IEgressOperation
    {
        ...
        public static async Task<ExecutionResult<EgressResult>> EndOfSessionEgressAsync(IServiceProvider serviceProvider, string endpointName, Func<Stream, CancellationToken, Task> action, string artifactName, string contentType, CancellationToken token)
        {
            ILogger<EgressOperation> logger = serviceProvider
                .GetRequiredService<ILoggerFactory>()
                .CreateLogger<EgressOperation>();
            ...
            return await ExecutionHelper.InvokeAsync(async (token) =>
            {
                ...
                Func<IEgressService, CancellationToken, Task<EgressResult>> egress = (service, token) => service.EndOfSessionEgressAsync(endpointName, action, artifactName, contentType, token);
